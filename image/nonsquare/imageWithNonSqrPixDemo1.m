function imageWithNonSqrPixDemo1
...
for n = 1:2
    ...
    if n==1
        [X, map] = imread('matlabicon_indexed.png', 'png');
        figure('Color', 'w', 'NumberTitle', 'Off', ...
            'Name', 'Demo 1 - imageWithNonSqrPix.m - Indexed colors')
        colormap(map);
    else
        X = imread('matlabicon_rgb.png', 'png');
        figure('Color', 'w', 'NumberTitle', 'Off', ...
            'Name', 'Demo 1 - imageWithNonSqrPix.m - RGB colors')
    end
